    ...
    <Wrapper color={color}>
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M9.62916 0C8.44495 0 7.32161 0.524718 6.56161 1.43287L0.466227 8.71643C-0.155409 9.45925 -0.155409 10.5408 0.466227 11.2836L6.56161 18.5671C7.32161 19.4753 8.44495 20 9.62915 20H17.0029V0H9.62916ZM9.97546 12.6316C11.4198 12.6316 12.5907 11.4534 12.5907 10C12.5907 8.54662 11.4198 7.36842 9.97546 7.36842C8.53112 7.36842 7.36025 8.54662 7.36025 10C7.36025 11.4534 8.53112 12.6316 9.97546 12.6316Z"
          fill="none"
        />
      </svg>
...
const Wrapper = styled.div`
  ...
  position: relative;
  padding: 0 0 0 17px;
  color: ${props => handleTextColor(props.color, false, true)};
  ...
  .badge__dot {
    ...
    left: 0;
    top: 0;
    fill: ${props => handleBackgroundColor(props.color, false, true)};
    height: 20px;
    path {
      fill: ${props => handleBackgroundColor(props.color, false, true)};
    }
  ...
  .badge__data {
    ...
    padding: 0 ${DT.SPACE_3} 0 ${DT.SPACE_1};
    gap: ${DT.SPACE_2};
    white-space: nowrap;
  }
  .name {
  ...
  .icon {
    fill: ${props => handleTextColor(props.color, false, true)};
  }
`;
